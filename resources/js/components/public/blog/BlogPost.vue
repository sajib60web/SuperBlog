                                ...
                                <div class="span8">
                                    <div class="post-image">
                                        <div class="post-heading">
                                            <h3>
                                                <router-link :to="`/blog-details/${post.id}`">{{post.title}}</router-link>
                                            </h3>
                                        </div>
                                        <img :src="`uploadimage/${post.photo}`" alt="Blog Image" style="width: 800px; height: 300px; border: 1px solid green">
                                    </div>
                                    ...
                                    <div class="bottom-article">
                                        ...
                                        <router-link :to="`/blog-details/${post.id}`" class="pull-right">Continue reading <i class="icon-angle-right"></i></router-link>
                                    </div>
                                </div>
                            </div>
                        </article>
